...
import 'repairapplyteacher.dart';
import 'repairwriteteacher.dart';

class RepairListTeacher extends StatefulWidget {
  const RepairListTeacher({super.key});

  @override
  State<RepairListTeacher> createState() => _RepairListTeacherState();
}

class _RepairListTeacherState extends State<RepairListTeacher> {
                  ...
                  return Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return data.teacherName == null ?
                          GestureDetector(
                            onLongPress: (){
                              Get.to(() => RepairApplyTeacher(data: data));
                            },
                            child: Container(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(DateFormat('M월 d일(E)', 'ko_KR')
                                          .format(data.appTime!)),
                                      if(data.etc != null) Text(data.etc!),
                                    ],
                                  ),
                                  const SizedBox(
                                    width: 15,
