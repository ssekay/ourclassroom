...
class RepairWriteTeacher extends StatefulWidget {
  const RepairWriteTeacher({super.key});

  @override
  State<RepairWriteTeacher> createState() => _RepairWriteTeacherState();
}

class _RepairWriteTeacherState extends State<RepairWriteTeacher> {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (repairController.selectedFile.value != null) {
                          repairData?.etc = null;
                          repairData?.status = 'apply';
                          repairData?.teacherName = Constants.currentUser.name;
                          _submitForm();
                          Get.back();
                        } else {
