...
class ApiService {
  ...
  // 교육청 공공 데이터 정보
  static const String _niceApiKey = '085f11887a88414689ffd02e6578feed';
  ...
  static String _cleanupText(String? text) {
    ...
    // HTML 태그 (br 제외) 및 amp; 제거
    cleanedText = cleanedText.replaceAll(_htmlTagRegex, '');
    // 알레르기 정보 형태가 아닌 괄호와 그 내용 제거
    cleanedText = cleanedText.replaceAll(_allergyInfoKeepRegex, '');
    // 연속된 공백을 단일 공백으로, 앞뒤 공백 제거
